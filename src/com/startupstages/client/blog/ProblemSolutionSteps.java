...
public class ProblemSolutionSteps extends HorizontalPanel {
    ...
    private VerticalPanel vpIdea() {
        ...
        Image imgIdea = new Image("images/IdeaIcon.png");
    ...
    private VerticalPanel vpProblem() {
        ...
        Anchor anchorProblem = new Anchor("<font size=3><b>Problem</b></font>", true);
        anchorProblem.addClickHandler(problemClick);
        vpProblem.add(anchorProblem);

        Image imgProblem = new Image("images/ProblemIcon.jpg");
    ...
    private VerticalPanel vpSolution() {
        ...
        Anchor anchorSolution = new Anchor("<font size=3><b>Solution</b></font>", true);
        vpSolution.add(anchorSolution);

        Image imgSolution = new Image("images/SolutionIcon.jpg");
    ...
    private VerticalPanel vpBrand() {
        ...
        Image imgBrand = new Image("images/TryButton.jpg");
    ...
    private VerticalPanel vpFeature() {
        ...
        Anchor anchorFeature = new Anchor("<font size=3><b>Feature</b></font>", true);
        vpFeature.add(anchorFeature);

        Image imgFeature = new Image("images/target.jpg");
